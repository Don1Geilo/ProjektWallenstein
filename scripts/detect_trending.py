...
from wallenstein.reddit_scraper import detect_trending_tickers, update_reddit_data
...
def main():
    ...
    parser.add_argument(
        "--min-mentions", type=int, default=3, help="Minimum mentions to be considered"
    )
    parser.add_argument(
